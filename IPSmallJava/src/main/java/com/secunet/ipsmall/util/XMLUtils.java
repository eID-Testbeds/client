...
public class XMLUtils {
    ...
    /**
     * Unmarshal XML data from XML string using XSD from file path and return the resulting JAXB content tree
     *
     * @param packageName
     *            package name for creating related JAXB context
     * @param strXML
     *            XML
     * @param strXSDFilePath
     *            XSD file path
     ...
     *             in error case
     */
    public static Object doUnmarshallingFromFiles(String packageName, String strXML, String strXSDFilePath) throws Exception {
        if (packageName == null) {
            throw new RuntimeException("No package name (null)!");
        }
        if (strXML == null) {
            throw new RuntimeException("No XML file path (null)!");
        }
