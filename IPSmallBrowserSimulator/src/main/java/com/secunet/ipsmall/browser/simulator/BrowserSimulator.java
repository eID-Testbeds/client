...
public class BrowserSimulator {
    ...
    public static void main(String args[]) {
        try {
            if (args.length != 1) {
                System.err.println("Usage: java -jar browsersimulator.jar [IP address to bind server to]");
                System.exit(0);
            }
            ...
            final BrowserSimulatorRmiServer rmiServer = new BrowserSimulatorRmiServer();
